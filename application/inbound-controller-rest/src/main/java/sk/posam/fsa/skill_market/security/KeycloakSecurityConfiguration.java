    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/v1/projects/**")
                        .hasAnyRole("CLIENT", "ADMIN")
                        .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/v1/projects/**")
                        .hasAnyRole("CLIENT", "FREELANCER", "ADMIN")
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/v1/projects/*/offers", "/api/v1/projects/*/offers/*/accept", "/api/v1/projects/*/offers/*/reject")
                        .hasAnyRole("CLIENT", "FREELANCER", "ADMIN")
